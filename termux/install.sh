...
wget -O ~/proxypool-$last_version/config/config.yaml https://raw.githubusercontent.com/shoujiyanxishe/proxypool/main/termux/config.yaml
wget -O ~/proxypool-$last_version/config/source.yaml https://raw.githubusercontent.com/shoujiyanxishe/proxypool/main/termux/source.yaml
